(function($){   
    ...
    function newsBlockHeight() {
        ...
        setTimeout(function() {
            nHeight = $('.newsletter-wrap .col-sm-9').outerHeight();
            if (nHeight > 630) {
                nHeight = 507;
            } 
            $('.newsletter-wrap .col-sm-3').outerHeight(nHeight);
            $('.newsletter-wrap .col-sm-9').outerHeight(nHeight);
            newsBlockPos(); 
        }, 1000);
    ...
    function newsBlockPos() {
        setTimeout(function () {
           newsBHeight = $('.newsletter-wrap .col-sm-3').outerHeight();
