...
function zerif_customize_register( $wp_customize ) {
	...
	if ( class_exists( 'WP_Customize_Panel' ) ):
		...
		/* title */
		$wp_customize->add_setting( 'zerif_smalltitle_title', array(
            'sanitize_callback' => 'zerif_sanitize_input',
            'default' => __('Organized','zerif-lite'),
            'transport' => 'postMessage'
        ));

        $wp_customize->add_control( 'zerif_smalltitle_title', array(
            'label'    => __( 'Small Title', 'zerif-lite' ),
            'section'  => 'zerif_bigtitle_section',
            'priority'    => 2,
        ));
	...
	if ( class_exists( 'WP_Customize_Panel' ) ):
		...
		$wp_customize->add_panel( 'panel_about', array(
			'priority' => 34,
			'capability' => 'edit_theme_options',
			'title' => __( 'Lifestyle section', 'zerif-lite' )
		));
		...
		$wp_customize->add_control( 'zerif_aboutus_show', array(
			'type' => 'checkbox',
			'label' => __('Hide lifestyle section?','zerif-lite'),
        ...
        $wp_customize->add_control( 'zerif_aboutus_clients_title_text', array(
            'label'    => 'Title',
            'description' => 'This title appears only if you have widgets in the Lifestyle sidebar.',
