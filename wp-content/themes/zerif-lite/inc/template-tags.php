...
function zerif_footer_widgets_function() {
	if(is_active_sidebar( 'zerif-sidebar-footer' ) || is_active_sidebar( 'zerif-sidebar-footer-2' ) || is_active_sidebar( 'zerif-sidebar-footer-3' )):
		if(is_active_sidebar( 'zerif-footer-bottom' )):
		...
		if(is_active_sidebar( 'zerif-sidebar-footer' )):
			echo '<div class="footer-widget col-xs-12 col-sm-6">';
			dynamic_sidebar( 'zerif-sidebar-footer');
		endif;
		if(is_active_sidebar( 'zerif-sidebar-footer-2' )):
			echo '<div class="footer-widget col-xs-12 col-sm-3">';
			dynamic_sidebar( 'zerif-sidebar-footer-2' );
			echo '</div>';
		endif;
		...
		if(is_active_sidebar( 'zerif-footer-bottom' )):
			echo '<div class="col-sm-12">';
			dynamic_sidebar( 'zerif-footer-bottom' );
			echo '</div>';
		endif;
		echo '</div>';
		echo '</div>';
...
function zerif_small_title_text_function() {

	$zerif_smalltitle_title = get_theme_mod('zerif_smalltitle_title',__('ONE OF THE TOP 10 MOST POPULAR THEMES ON WORDPRESS.ORG','zerif-lite'));

	if( !empty($zerif_smalltitle_title) ):

		echo '<h2 class="intro-text">'.wp_kses_post( $zerif_smalltitle_title ).'</h2>';

	elseif ( is_customize_preview() ):

		echo '<h2 class="intro-text zerif_hidden_if_not_customizer"></h2>';
