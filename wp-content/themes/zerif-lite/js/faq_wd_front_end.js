(function ($) {
    ...
    function faqwd_search($container) {
        ...
        function hide_main_list() {
            ...
            if($('.faqwd_categories').hasClass('faqwd_hidden')) {

                $('.faqwd_conteiner .faqwd_cat').removeClass('faqwd_hidden');

                $('.faqwd_conteiner .faqwd_cat').each(function() {

                    $this = $(this);

                    var flag = 0;

                    $this.find('ul .faqwd_question_li').each(function() {

                        if(!($(this).hasClass('faqwd_hidden'))) {
        ...
        this.restor_faq = function () {
            ...
            _this.$container.closest('.faqwd_conteiner').find('h1').removeClass("faqwd_hidden");
            //_this.$container.closest('.faqwd_conteiner').find('.faqwd_category_head_li').removeClass("faqwd_hidden");
            _this.$container.closest('.faqwd_conteiner').find('.faqwd_scroll_top').removeClass("faqwd_hidden");
        ...
        this.serach_view = function (search_data) {
            ...
            _this.$container.closest('.faqwd_conteiner').find('h1').addClass("faqwd_hidden");
            ...
            _this.$container.closest('.faqwd_conteiner').find('.faqwd_scroll_top').addClass("faqwd_hidden");
